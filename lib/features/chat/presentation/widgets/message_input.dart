        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              // Camera button
              _InputIconButton(
                key: const Key(AppConstants.cameraButtonKey),
              ...
              // Gallery button
              _InputIconButton(
                key: const Key(AppConstants.galleryButtonKey),
                icon: Icons.photo_library_rounded,
                tooltip: AppConstants.gallery,
                onPressed: widget.isLoading ? null : widget.onGalleryPressed,
              ),

              // Paste button
              _InputIconButton(
                key: const Key(AppConstants.pasteButtonKey),
              ...
              Expanded(
                child: Container(
                  ...
                  child: TextField(
                    key: const Key(AppConstants.messageInputKey),
              ...
              Container(
                ...
                child: IconButton(
                  key: const Key(AppConstants.sendButtonKey),
                  icon:
                      widget.isLoading
                          ? const SizedBox(
                            width: 16,
